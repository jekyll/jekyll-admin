...
export class MetaButtons extends Component {
  ...
  render() {
    const { currentType, onDropdownFocus, onDropdownBlur } = this.props;
    return (
      <div className="meta-buttons">
        ...
        <span className="dropdown">
          ...
          <div className="dropdown-wrap">
            ...
            <span onMouseDown={() => this.handleRemoveClick()} className="remove-field"><i className="fa fa-trash"></i>Remove field</span>
          </div>
        </span>
      </div>
    );
