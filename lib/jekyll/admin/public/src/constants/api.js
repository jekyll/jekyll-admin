...
export const PUT_CONFIGURATION = 'http://localhost:3004/configuration';

export const GET_PAGES = 'http://localhost:3004/pages';
export const GET_PAGE = 'http://localhost:3004/pages/';
export const PUT_PAGE = 'http://localhost:3004/pages/';
...
export const PUT_COLLECTION_DOCUMENT = 'http://localhost:3004/collections/';
