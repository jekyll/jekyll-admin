  ...
  renderCollections() {
    ...
    if (collections.length) {
      ...
      .map((col, i) => {
        return (
          <li key={i}>
            <Link activeClassName="active" to={`${ADMIN_PREFIX}/collections${col.path}`}>
      ...
      <div className="sidebar">
        ...
        <div className="routes">
          <ul>
            ...
            <Splitter />
            <li>
              <Link activeClassName="active" to={`${ADMIN_PREFIX}/data`}><i className="fa fa-database"></i>Data</Link>
            </li>
            <li>
