...
// Actions
import { fetchPage, deletePage, postPage } from '../../actions/pages';
...
export default class PageEdit extends Component {
  ...
  render() {
    const { page, isFetching, postPage, deletePage, errors, updated, fieldChanged,
      updateTitle, updateBody, updatePath, updateDraft } = this.props;
