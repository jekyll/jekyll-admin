...
describe('Form helper functions:', () => {
  describe('validateForm', () => {
    it('should not generate error messages if validated', () => {
      let metadata = {
        body: "",
        title: 'Test',
        metadata: {
      ...
      let errorMessages = validateForm(metadata, "posts");
    ...
    it('should not generate error messages for pages if date not provided', () => {
      let metadata = {
        ...
        metadata: {
          draft: false,
          path: '2016-01-11-awesome.md'
        }
      };
      let errorMessages = validateForm(metadata, "pages");
