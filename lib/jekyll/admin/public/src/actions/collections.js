...
export function fetchCollectionDocuments(collection_name) {
  return dispatch => {
...
export function fetchCollectionDocument(collection_name, document_id) {
  return dispatch => {
...
export function putCollectionDocument(document_id, doc) {
...
export function deleteCollectionDocument(document_id) {
